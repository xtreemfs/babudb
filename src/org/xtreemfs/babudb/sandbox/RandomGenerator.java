...
import static org.xtreemfs.babudb.sandbox.RandomGenerator.Operation.*;
...
public class RandomGenerator {
    ...
    public final static long MIN_SEQUENCENO = 1000L;
    ...
    static enum Operation { copy, delete, create };
