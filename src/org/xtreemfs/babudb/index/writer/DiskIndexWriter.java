 ...
 * the given max file size. Multiple files are necessary to handle databases
 * larger than 2 GB on 32-bit systems due to MMap limitations.
 *
...
public class DiskIndexWriter {
     ...
     *
     * @param path The path to the directory where the index will be written. The
     *             directory is created if it does not yet exist.
     * @param maxBlockEntries The maximum number of entries in a single block.
     * @param compressed Indicates if the blocks should be compressed.
     * @param maxFileSize The max size of a file storing blocks in bytes. On a
     *                    32-bit system this should not be larger than 2GB.
     * @throws IOException
     */
     ...
     * @throws IOException
     */
    private void writeIndex(String path, BlockWriter blockIndex, Iterator<Entry<byte[], byte[]>> iterator) throws IOException {
