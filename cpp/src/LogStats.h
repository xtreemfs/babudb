...
public:
	...
	Stats( const Stats& other ) : name( other.name ), global_registries( NULL ),
		first_timestamp( other.first_timestamp ), last_sample_timestamp( other.last_sample_timestamp )
		{}
...
public:
	...
	LogStats( const string& name, GlobalRegistries* r ) : Stats( name, r ),
		log_file_length( 0 ), log_length( 0 ), gaps_length( 0 ), no_of_gaps( 0 ), no_of_deletors( 0 ),
		no_of_records( 0 ), bytes_appended_in_period( 0 ), appends_in_period( 0 )
		{}


	LogStats( const LogStats& o ) : Stats( o ),
...
public:
	LogDatabaseStats( const string& name, GlobalRegistries* r ) : LogStats( name, r ),
		...
		no_of_blocks( 0 ), no_of_updates( 0 ), update_rate( 0 ), no_of_updates_in_period( 0 ),
		cleanup_records_moved( 0 ), cleanup_offset( 0 ) {}
	...
	LogDatabaseStats( const LogDatabaseStats& o ) : LogStats( o ),
		...
		no_of_blocks( o.no_of_blocks ), no_of_updates( o.no_of_updates ), update_rate( o.update_rate ), no_of_updates_in_period( o.no_of_updates_in_period ),
	...
	// Cloneable
//	Cloneable* clone() { return new LogDatabaseStats( *this ); }
